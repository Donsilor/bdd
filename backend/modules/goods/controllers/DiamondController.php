    ...
    */
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel
            ->search(Yii::$app->request->queryParams, ['goods_name','language','created_at', 'hk_status', 'cn_status', 'us_status']);
...
DOM;
        ...
        $dataProvider->query->select(['goods_diamond.*', 'goods.hk_status', 'goods.cn_status', 'goods.us_status']);
