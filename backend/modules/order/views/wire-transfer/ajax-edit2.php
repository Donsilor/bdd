...
$form = ActiveForm::begin([
    ...
    'validationUrl' => Url::to(['ajax-edit2','id' => $model['id']]),
    'fieldConfig' => [
...
?>
    ...
    <div class="modal-body">
        <div class="form-group field-wiretransfer-collection_amount">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="<?= $model->orderTourist->order_sn; ?>" readonly="true">
        ...
        <div class="form-group field-wiretransfer-collection_amount">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="<?= \common\helpers\AmountHelper::outputAmount($model->orderTourist->order_amount,2,$model->orderTourist->currency) ?>" readonly="true">
                <div class="help-block"></div>
            </div>
        </div>
        <div class="form-group field-wiretransfer-collection_amount">
            ...
            <div class="col-sm-10">
                <?php
                $pay_amount = $model->orderTourist->pay_amount;
                if($model->orderTourist->currency == \common\enums\CurrencyEnum::TWD) {
                    $pay_amount = sprintf('%.2f', intval($pay_amount));
                }
                ?>
                <input type="text" class="form-control" value="<?= \common\helpers\AmountHelper::outputAmount($pay_amount,2,$model->orderTourist->currency) ?>" readonly="true">
                <div class="help-block"></div>
            </div>
        </div>
        <div class="form-group field-wiretransfer-collection_amount">
