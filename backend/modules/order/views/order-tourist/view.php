                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 text-right"><label><?= $model->getAttributeLabel('account.coupon_amount') ?>
                                            ：</label></div>
                                    <div class="col-lg-7"><?= $model->currency ?>&nbsp;<?= \common\helpers\AmountHelper::rateAmount(-$model->coupon_amount, 1, 2, ',') ?></div>
                                </div>
                                <?php
                                $cardUseAmount = 0;
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                    $receivable = $model->pay_amount;//bcadd($model->order_amount, $cardUseAmount, 2) + $model->discount_amount;
                                    ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 text-red"><?= \Yii::$app->services->currency->getSign() ?>&nbsp;<?= \common\helpers\AmountHelper::rateAmount(!$model->payment_status?0:$model->pay_amount, 1/$model->exchange_rate, 2, ',') ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
